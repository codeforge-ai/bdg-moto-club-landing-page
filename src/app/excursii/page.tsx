...
export const metadata: Metadata = {
  ...
  description:
    "Descoperă excursiile organizate de Club Moto: aventuri pe cele mai frumoase trasee din România și Europa, hărți interactive, statistici și oportunități de înscriere pentru pasionații de motociclete.",
  keywords:
